                      ...
                      <>
                        ...
                        >
                          <img
                            src={xray.fileUrl}
                            alt={`${xray.type} X-Ray`}
                            className="w-full h-full object-contain shadow-[0_0_100px_rgba(0,0,0,0.8)] border border-white/5 transition-all"
                            style={{
                              transform: `rotate(${rotation}deg)`,
                              filter: `brightness(${brightness}%) contrast(${contrast}%)`,
                              transition: "transform 0.4s cubic-bezier(0.2, 0, 0, 1), filter 0.2s ease",
                            }}
                            draggable={false}
                          />
                        </TransformComponent>
